  ...
  render() {
    return (
      <Container>
        ...
        <h2 className="h2Class">Vote for favourite Football team ?</h2>
        ...
        <button onClick={()=> this.onVote("5c0a1bdfe7179a6ca0844567","RealMadrid")}>Vote</button>
      </Container>
    );
  }
}
